...
const UsersList = (props) => {
    ...
    const isChatting = !!props.selectedUser;

    return (
        <div className={`flex flex-col h-full ${isChatting ? 'sm:flex hidden' : 'flex'}`}>
            {/* Mobile back button in chat view */}
            {isChatting && (
                <div className="sm:hidden p-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900">
                    <button
